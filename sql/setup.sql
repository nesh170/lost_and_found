...
CREATE TABLE IF NOT EXISTS lost_items(
  ...
  CONSTRAINT FK_lost_items_found_id FOREIGN KEY (found_id) REFERENCES found_items (id)
);
...
CREATE TABLE found_items(
  ...
  CONSTRAINT FK_found_items_lost_id FOREIGN KEY (lost_id) REFERENCES lost_items (id)
